...
/* 
   ...
   introduced here is only a matter of syntax. Keep opened the code of
   the previous example while you read this one, in order to compare
   the two formulations of the same execution, i.e the one you had
   previously and the new one we introduce here. 
*/
