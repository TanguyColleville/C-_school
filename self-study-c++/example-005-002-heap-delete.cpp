...
int main(int argc, char* argv[]) {
  ...
  // receive a "segmentation fault" signal from the system and die.
  ...
  // (releasing, deleting is called freeing in the core memory
  // management). This is a bug as well.
  ...
  delete ptr1; // This does nothing, and no crash.
  delete ptr2; // This does nothing, and no crash.
